...
mkdir release
ps2exe -inputFile .\windows\RaceDBController.Export.ps1 -outputFile .\release\RaceDBController.exe -x64 -noConsole -title "RaceDB Controller" -version 1.0.0 -noOutput -noError
copy racedb.env release\
copy docker-compose*.yml release\
copy dbconfig.env.tmpl release\
copy migrate.cmd release\
